...
export default function Sidebar({ user }: { user: any }) {
    ...
    const menuItems = [
        { icon: LayoutDashboard, label: 'Dashboard', href: '/', roles: ['ADMIN', 'PIC', 'SECURITY', 'LINGKUNGAN', 'STAFF'] },
        { icon: UserCheck, label: 'Absensi Presensi', href: '/attendance', roles: ['ADMIN', 'PIC', 'SECURITY', 'LINGKUNGAN', 'STAFF'] },
