...
export default async function AdminIncidentsPage() {
    ...
    if (!session || (session.role !== 'ADMIN' && session.role !== 'PIC')) {
        redirect('/login');
    }
    ...
    return (
        <div className="p-4 md:p-8 space-y-8 pb-24">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl md:text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Incident Monitoring</h1>
